...
#import "GradeStates.h"

/*!
 *  Grade event protocol
 */
@protocol GradeEventDelegates
...
/*!
 *  REfernce to forecourt the grade belongs to.
 */
 ...
 */
-(void) addDelegate:(id<GradeEventDelegates>)delegate;

/*!
 *  Removes the passed delgate from the list of delegates called on grade events.
 *
 *  @param delegate The delegate to remove.
 */
-(void) removeDelegate:(id<GradeEventDelegates>)delegate;
 ...
 */
@interface GradeCollection : NSObject <GradeEventDelegates, NSFastEnumeration >
 ...
 *  Each grade event will return a refernce to the grade firing the event.
 *
 *  @param delegate The delegate to add
 */
-(void) addDelegate:(id<GradeEventDelegates>)delegate;
