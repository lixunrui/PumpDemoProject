...
#import "FuelTransactionStates.h"
@class ENBHose;

/*!
 *  Contains the Authorisation details of a transaction.
 */
@interface ENBTransactionAuthoriseData : NSObject

/**
 *  The date and time when the fuel transaction was authorised
 */
@property (readonly)NSDate* authoriseDateTime;

/**
 *  Returns the money limit set when the fuel transaction wa authorised, or 0 if there was no money limit
 */
...
/**
 *  Returns the quantity limit set when the fuel transaction wa authorised, or 0 if there was no quality limit
 */
@property (readonly)NSDecimalNumber* quantityLimit;

/**
 *  Indicates the reason th fuel transaction was authorised
 */
@property (readonly)ENBAuthoriseReason reason;

/**
 *  Returns the terminal ID that authorised the transaction
 */
...
/**
 *  Returns the date and time the transaction was authorised
 */
@property (readonly)NSDate* authoriseDateTime;
...
/**
 *  Returns a reference to the authorisation data associated with the transaction
 */
...
/**
 *  Returns a client activity code supplied when this transaction was authorised
 */
@property (readonly)NSString* clientActivity;

/**
 *  Returns a client Reference string supplied when this transaction was authorised
 */
 ...
 */
@interface TransactionCollection : NSObject <NSFastEnumeration>
