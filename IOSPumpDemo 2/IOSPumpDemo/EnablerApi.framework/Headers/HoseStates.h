...
typedef NS_ENUM( NSUInteger, ENBHoseBlockedReason)
{
    ...
    /*!
     *  The grade associatted with was manually blocked by user.
     */
    ENBHoseBlockedReasonGradeManual = 1,
    /*!
     *  The Hose is blocked because the associatted tank is blocked.
     */
    ...
    /*!
     *  The Hose is blocked because associatted Tank has a Low Level alarm.
     */
