...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _tabbarController = [storyBoard instantiateViewControllerWithIdentifier:@"MainBoard"];
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    if ([_forecourt isConnected]) {
        [_forecourt disconnectWithMessage:@"Application Logoff"];
        _forecourt = nil;
...
- (void)onServerEvent
{
    if (_isConnected) {
        ...
        _isConnected = NO;
        _forecourt = nil;
        UIAlertView* lostConnectionView = [[UIAlertView alloc]initWithTitle:@"Error" message:@"Lost Connection" delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
